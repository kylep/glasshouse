...
public enum GlasshouseSensors {
    ...
    public static func liveRegistry() -> SensorRegistry {
        ...
        SensorRegistry([
            ...
            LiveCameraCaptureSource(),
            LiveCalendarWriteOnlySource(),
            ...
            LiveSignificantChangeSource(),
            LiveVisitsSource(),
            LiveRegionMonitoringSource(),
            LivePhotoLibrarySource(),
            LivePhotoLocationSource(),
            LiveVisionTextSource(),
            LiveVisionFacesSource(),
            LiveBluetoothScanSource(),
            LiveNearbyInteractionSource(),
            LiveContactsSource(),
