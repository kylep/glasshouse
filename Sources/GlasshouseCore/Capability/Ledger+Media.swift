extension CapabilityLedger {
    ...
    static let media: [Capability] = [
        ...
        Capability(
            ...
            framework: "Photos",
            reveals: "Where each photo was taken, and when. A camera roll spanning years contains a corresponding span of location data.",
            plistKeys: ["NSPhotoLibraryUsageDescription"],
            simulator: .worksFully,
        ...
        Capability(
            ...
            framework: "Vision",
            reveals: "Text found in your photographs — signs, documents, whiteboards, screenshots — converted to searchable strings.",
            simulator: .worksFully,
            sensitivity: .personal,
            gate: .neverAsks,
