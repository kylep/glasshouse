extension CapabilityLedger {
    ...
    static let personalData: [Capability] = [
        Capability(
            ...
            framework: "Contacts",
            reveals: "Names, phone numbers, emails, street addresses, birthdays, employers, and relationships for everyone in your address book. The records describe other people.",
        ...
        Capability(
            ...
            framework: "EventKit",
            reveals: "Event titles, attendees, locations, dates and recurrence, past and future. Records where you were and who you were with.",
