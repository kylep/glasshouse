extension CapabilityLedger {
    ...
    static let coreLocation: [Capability] = [
        Capability(
            ...
            reveals: "Coordinates to within a few metres, plus altitude, speed and course. Published research shows four approximate location points are enough to identify most people uniquely.",
        ...
        Capability(
            ...
            framework: "CoreLocation",
            reveals: "Location updates when you move a significant distance. Delivered in the background, and iOS will relaunch the app to deliver them.",
        ...
        Capability(
            ...
            displayName: "Visits",
            framework: "CoreLocation",
            reveals: "Places where you stopped and how long you stayed, derived by iOS from dwell time. Locations rather than routes.",
            plistKeys: ["NSLocationAlwaysAndWhenInUseUsageDescription", "NSLocationWhenInUseUsageDescription"],
            simulator: .returnsNothing,
            sensitivity: .intimate,
            gate: .asksOnce,
