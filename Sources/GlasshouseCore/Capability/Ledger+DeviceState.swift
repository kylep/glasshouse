extension CapabilityLedger {
    ...
    static let deviceState: [Capability] = [
        ...
        Capability(
            ...
            displayName: "Storage",
            framework: "Foundation",
            reveals: "Free and total storage. Apple lists this as a required-reason API because it can be used for device fingerprinting.",
            simulator: .worksWithCaveats,
            sensitivity: .identifying,
            gate: .neverAsks,
        ...
        Capability(
            ...
            displayName: "Uptime",
            framework: "Foundation",
            reveals: "Time since the last restart. Every app on the device computes the same value, and Apple lists boot time as a required-reason API because it can be used for fingerprinting.",
            simulator: .worksWithCaveats,
            sensitivity: .identifying,
            gate: .neverAsks,
        ...
        Capability(
            ...
            framework: "UIKit",
            reveals: "An identifier shared across every app from the same developer. It persists until all of their apps are removed from the device.",
        ...
        Capability(
            ...
            framework: "UIKit",
            reveals: "Whether VoiceOver, larger text, reduced motion or increased contrast are enabled. These settings can correlate with disability.",
            simulator: .worksFully,
        ...
        Capability(
            ...
            framework: "UIKit",
            reveals: "Whether the clipboard holds a URL, a number, or text. Apple documents these checks as not triggering the paste banner.",
            simulator: .worksFully,
            sensitivity: .personal,
            gate: .neverAsks,
        ...
        Capability(
            ...
            framework: "UIKit",
            reveals: "The text or URL currently on your clipboard. Reading it triggers the system paste banner.",
            simulator: .worksFully,
            sensitivity: .personal,
            gate: .tellsYouAfter,
            source: "https://developer.apple.com/documentation/uikit/uipasteboard",
            verified: "2026-08-30",
            notes: "Gated as tellsYouAfter: no permission dialog is involved, but the iOS 16+ banner appears after the read. A notification is not consent, and the contrast with the silent read above is the teaching point. Drive fixtures with `simctl pbcopy`."
        ),
        Capability(
